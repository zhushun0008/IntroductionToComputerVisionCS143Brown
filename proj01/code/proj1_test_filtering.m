...
%% My test for odd dimension of kernel.
identity_filter1 = [0 0 ; 1 0];
identity_filter2 = [0 0 1; 1 0 0];
identity_filter3 = [0 0;1 0 ; 0 0];

% identity_image  = my_imfilter(test_image, identity_filter1);
% identity_image  = my_imfilter(test_image, identity_filter2);
% identity_image  = my_imfilter(test_image, identity_filter3);
...
identity_image1  = imfilter(test_image, identity_filter);


figure(2); imshow(identity_image);
figure(3); imshow(identity_image1);
